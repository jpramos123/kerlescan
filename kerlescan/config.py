...
inventory_svc_hostname = load_hosts_setting("INVENTORY_SVC_URL", 'host-inventory', "http://inventory_svc_url_is_not_set")

baseline_svc_hostname = load_hosts_setting("BASELINE_SVC_URL", 'baseline', "http://baseline_svc_url_is_not_set")
